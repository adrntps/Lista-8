...
# O loop corre para cada um dos 50 números gerados anteriormente.
    ...
    constraints = [alpha <= 1, gamma >> 0, gamma[0][0] == 1, gamma[0][1] == P_abxy[0]+P_abxy[1]-P_abxy[2]-P_abxy[3], gamma[0][2] == P_abxy[8]+P_abxy[9]-P_abxy[10]-P_abxy[11], 
                   gamma[0][3] == P_abxy[0]+P_abxy[2]-P_abxy[1]-P_abxy[3], gamma[0][4] == P_abxy[4]+P_abxy[6]-P_abxy[5]-P_abxy[7], gamma[1][1] == 1,
                   gamma[1][3] == P_abxy[0]+P_abxy[3]-P_abxy[1]-P_abxy[2], gamma[1][4] == P_abxy[4]+P_abxy[7]-P_abxy[5]-P_abxy[6], gamma[2][2] == 1,  gamma[2][3] == P_abxy[8]+P_abxy[11]-P_abxy[9]-P_abxy[10],
                   gamma[2][4] == P_abxy[12]+P_abxy[15]-P_abxy[13]-P_abxy[14],  gamma[3][3] == 1, gamma[4][4] == 1]
